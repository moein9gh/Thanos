export function messageToClient(success: Boolean, errorMessage: string | null, message: string, body: any = {}) {
...
export function getMobiles(str) {
    if ((str.length != 10 || !(str.length == 10 && str.indexOf("9") == 0)) && (str.length != 11 || !(str.length == 11 && str.indexOf("0") == 0)) && (str.length != 12 || !(str.length == 12 && str.indexOf("98") == 0)) && (str.length != 13 || !(str.length == 13 && str.indexOf("+98") == 0))) {
